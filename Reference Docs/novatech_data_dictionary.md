...
share `account_id` as a common join key.
...
Sales pipeline data — 499 closed-deal records (won and lost).

#### `account_id`

- **Type:** String
- **Description:** Account identifier repeated across deals. Common join key across all three datasets.
...
- **Nulls:** None
- **Notes:** `Philipines` is the spelling stored in the source file and is preserved here as a valid source value. The standard spelling is `Philippines`.

#### `opportunity_id`

- **Type:** String
- **Description:** Identifier for a sales opportunity.
- **Example:** OPP-13278, OPP-24592, OPP-93810
- **Nulls:** None
- **Notes:** Format: `OPP-XXXXX`. The source has 496 distinct values across 499 rows; `OPP-44760`, `OPP-82512`, and `OPP-98039` each occur twice.
...
- **Type:** String
- **Description:** Account identifier repeated across marketing leads. Join key to CRM and Support datasets.
...
- **Type:** String
- **Description:** Account identifier repeated across support tickets. Join key to CRM and Marketing datasets.
- **Nulls:** None
...
- **Type:** String
- **Description:** Identifier for a support ticket.
- **Example:** TKT-966028, TKT-768507, TKT-786393
- **Nulls:** None
- **Notes:** Format: `TKT-XXXXXX`. The source has 2,996 distinct values across 3,000 rows; `TKT-284055`, `TKT-634299`, `TKT-679459`, and `TKT-946331` each occur twice.
...
- **Nulls:** 59 rows (2.0%)
- **Notes:** Blank sentiment values are retained as a source-data quality condition.
