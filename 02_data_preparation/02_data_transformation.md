...
**CRM Deals Dataset**
![CRM field type corrections](image-1.png)

**Marketing Campaign Dataset**
![Marketing field type corrections](image-2.png)

**Customer Health Dataset**
![Support-ticket field type corrections](image.png)
...
**CRM Deals Dataset**
![CRM calculated-field steps](image-3.png)

**Marketing Campaign Dataset**
![Marketing calculated-field steps](image-4.png)

**Customer Health Dataset**
![Support calculated-field steps](image-5.png)

## 3. Unified dataset

![Full transformation flow for the unified Customer Health dataset](image-10.png)
...
![CRM aggregation flow and account-level total deal value](image-16.png)
![Account-level won-revenue aggregation after filtering for won deals](image-14.png)
...
![Marketing measures aggregated to one row per account](image-15.png)
...
![First left join between support tickets and the CRM account summary](image-11.png)

**Second left join: the first joined result to the marketing account summary on `account_id`.**

![Second left join adding the marketing account summary](image-12.png)
...
**CRM Deals Dataset**
![CRM deals dataset stored in SPICE](image-9.png)

**Marketing Campaign Dataset**
![Marketing campaigns dataset stored in SPICE](image-8.png)

**Customer Health Dataset**
![Support-ticket dataset stored in SPICE](image-6.png)

**Unified Dataset**
![Unified Customer Health dataset stored in SPICE](image-7.png)
